...
import VirtualizedItemList from "@/components/items/VirtualizedItemList";
...
const ItemsDisplay = ({ 
  ...
  const displayItems = useMemo(() => {
    return enablePagination 
      ...
      : items;
  }, [enablePagination, items, paginatedData]);
  ...
  // Use virtualization for large lists without pagination
  if (enableVirtualization && !enablePagination && items.length > 50) {
    return (
